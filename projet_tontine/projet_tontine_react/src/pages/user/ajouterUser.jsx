                        ...
                        <main>
                            ...
                            <div class="container-xl px-4 mt-4">
                                <nav class="nav nav-borders">
                                    <a class="nav-link active ms-0" href="ProfilAdmin.html">Profile</a>
                                    <a class="nav-link" href="ProfilSecurity.html">Security</a>
                                 </nav>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8">
                                            <div class="card shadow mb-4">
                                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                                    <h6 class="m-0 font-weight-bold text-primary">Account Details</h6></div>
                                            <div class="card-body">
                                                <form>
                                                    <div class="mb-3">
