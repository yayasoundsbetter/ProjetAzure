      ...
      const handleLogout = () => {
        ...
        useEffect(() => {
            const fetchData = async () => {
                try {
                    const response2 = await axios.get(`http://localhost:8085/utilisateurs/infoUser/${id}`);
                    const email = response2.data.email;
                    const cne = response2.data.cne;
                    const tel = response2.data.tel;
                    const adresse = response2.data.adresse;
                                ...
                                <div class="col-xl-4">
                                            <div class="card shadow mb-4">
                                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                                    <h6 class="m-0 font-weight-bold text-primary">Profile Picture</h6></div>
                                            <div class="card-body text-center">
                                                <img class="img-fluid w-50 h-50 mb-2" src="img/profile.webp" alt=""/>
                                    ...
                                    <div class="col-xl-8">
                                            <div class="card shadow mb-4">
                                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                                    <h6 class="m-0 font-weight-bold text-primary">Profile Admin</h6></div>
                                            <div class="card-body">
                                                <form>
                                                    <div class="mb-3">
                                                        <label class="" for="inputUsername">Nom Admin</label>
                                                        <input class="form-control" id="libelle" type="text" placeholder="Entrer libelle" value={nom}  />
                                                    </div>
                                                    <div class="row gx-3 mb-3">
                                                        <div class="col-md-6">
                                                            <label class="" for="inputFirstName">Prenom Admin</label>
                                                            <textarea class="form-control" id="description" type="text" placeholder="Enrer description" value={prenom}/>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="" for="inputLastName">CNE</label>
                                                            <input class="form-control" id="montant_total" type="text" placeholder="Entrer le montant total" value={cne}/>
                                                        </div>
                                                    </div>
                                                   
                                                    <div class="mb-3">
                                                        <label class="" for="inputEmailAddress">Email address</label>
                                                        <input class="form-control" id="inputEmailAddress" type="email" placeholder="Enter your email address" value={email}/>
                                                    </div>
                                                    <div class="row gx-3 mb-3">
                                                        <div class="col-md-6">
                                                            <label class="small mb-1" for="inputPhone">Adresse</label>
                                                            <input class="form-control" id="inputPhone" type="tel" placeholder="Enter your phone number"  value={adresse}/>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="small mb-1" for="inputBirthday">Téléphone</label>
                                                            <input class="form-control" id="inputBirthday" type="text" name="birthday" placeholder="Enter your birthday" value={tel}/>
                                                        </div>
                                                    </div>
